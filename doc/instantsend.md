...
This mechanism has been integrated into Bitcore-Node-Enig which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/raptor3um/insight-api-enig#web-socket-api](https://github.com/raptor3um/insight-api-enig#web-socket-api)
* API: [https://github.com/raptor3um/insight-api-enig#instantsend-transactions](https://github.com/raptor3um/insight-api-enig#instantsend-transactions)
