...
* enig.conf: contains configuration settings for enigd or enig-qt
* enigd.pid: stores the process id of enigd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by enigd or enig-qt
