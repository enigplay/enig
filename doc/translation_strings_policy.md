...
This document provides guidelines for internationalization of the Enig Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `enig_en.ts` remains unchanged.
