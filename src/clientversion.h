...
#error Client version information missing: version is not defined by enig-config.h or in any other way
#endif
...
/**
 * enigd-res.rc includes this file, but it cannot cope with real c++ code.
