...
/* EnigGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* EnigGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Enig"
#define QAPP_ORG_DOMAIN "enigplay.com"
#define QAPP_APP_NAME_DEFAULT "Enig-Qt"
#define QAPP_APP_NAME_TESTNET "Enig-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Enig-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Enig-Qt-regtest"
