...
from test_framework.test_framework import EnigTestFramework
...
class LLMQChainLocksTest(EnigTestFramework):
    def set_test_params(self):
        self.set_enig_test_params(6, 5, fast_dip3_enforcement=True)
