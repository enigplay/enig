...
"""Verify that starting enigd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start enigd with -h for help text")
        ...
        self.log.info("Start enigd with -version for version information")
