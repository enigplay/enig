...
rm -rf test_bitcoin.coverage/ enig-gtest.coverage/ total.coverage/
...
clean_exe src/enig-cli
clean_exe src/enigd
clean_exe src/enig-gtest
clean_exe src/enig-tx
clean_exe src/test/test_enig
clean_exe src/test/test_enig_fuzzy
...
clean_dep . src/config/enig-config.h.in
